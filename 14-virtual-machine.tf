resource "azurerm_virtual_machine" "pan_vm" {
  name                                              = "${var.vnet_name}-${var.environment}-palo-vm-${count.index}"
  ...
  storage_os_disk {
    name                                            = "${var.vnet_name}-${var.environment}-palo-os-${count.index}"
  ...
  os_profile {
    computer_name                                   = "${var.vnet_name}-${var.environment}-palo-vm-${count.index}"
